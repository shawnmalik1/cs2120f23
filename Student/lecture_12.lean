...
| _, _ => true
-/
def biimplication (a b : Bool):
Bool := implies a b && implies b a
...
#eval eval_expr e0 (fun J => false) --true
#eval eval_expr e1 (fun C => true) --true
#eval eval_expr e2 (fun B => true) --true
#eval eval_expr e3 (fun A => false) --true