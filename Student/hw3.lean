...
#reduce day2reward Day.Monday -- reward.money
#reduce day2reward Day.Friday --reward.money
#reduce day2reward Day.Saturday --reward.health
#reduce day2reward Day.Sunday -- reward.health
...
Answer here: 
Left Associative. This is because when looking at the output of the
three check statements, the second statement multiples the first nat
by the product of the other two, implying its left associative.
The same thing occurs in the third, where the two nats on the left are
multiplied with the third.
...
-- Here:
#eval first (1, "shawn", true) -- 1
#eval second (1, "shawn", true) -- shawn
#eval third (1, "shawn", true) -- true
...
#check ((1, "shawn"), true) -- (Nat x String) x Bool
